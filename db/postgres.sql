...
CREATE TABLE IF NOT EXISTS user_profiles (id BIGSERIAL PRIMARY KEY, external_user_id TEXT NOT NULL UNIQUE, email TEXT, full_name TEXT, role TEXT NOT NULL DEFAULT 'viewer', station TEXT, active INTEGER NOT NULL DEFAULT 1);
